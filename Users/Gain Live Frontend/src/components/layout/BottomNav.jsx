...
const BottomNav = () => {
  ...
  return (
    <nav className="bg-[#131318]/90 backdrop-blur-lg fixed bottom-0 w-full z-50 rounded-t-lg border-t-2 border-t-[#00F5FF]/20 shadow-[0_-10px_30px_-10px_rgba(0,245,255,0.15)]">
