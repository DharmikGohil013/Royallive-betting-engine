    ...
    <section className="relative w-full h-[618px] flex items-center justify-center overflow-hidden">
      <div className="absolute inset-0 z-0">
        ...
        <img
          ...
          alt="cinematic low angle view of a futuristic neon sports stadium at night with blue and cyan lighting effects and atmospheric haze"
          src={heroImage}
        />
      </div>
      <div className="relative z-20 px-6 flex flex-col items-center text-center">
        <h1 className="font-headline font-black text-5xl md:text-7xl tracking-tighter leading-none mb-6 text-on-surface">
          PLAY. WIN.
          <br />
