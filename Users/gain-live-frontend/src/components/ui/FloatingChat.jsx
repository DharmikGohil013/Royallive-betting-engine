const FloatingChat = () => {
  return (
    <button className="fixed right-6 bottom-24 z-40 bg-surface-container-highest w-14 h-14 rounded-full flex items-center justify-center shadow-2xl border border-primary-container/20 group md:right-[calc(50%-230px+1rem)]">
