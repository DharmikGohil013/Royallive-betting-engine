      ...
      <main className="relative z-10 w-full max-w-[440px]">
        ...
        <div className="bg-surface-container/70 backdrop-blur-xl rounded-xl p-8 shadow-2xl shadow-black/60 border border-outline-variant/5">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <button
              className="w-full gold-gradient text-on-primary font-bold py-4 rounded-lg shadow-lg shadow-primary/10 hover:brightness-110 active:scale-[0.98] transition-all duration-200 text-lg"
              type="submit"
            >
              Login
            </button>
